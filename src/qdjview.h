...
class QDjViewFind;
class QDjViewShapes;
class QDjViewSamplesArea;
class QDjViewText;
class QDjViewPoliqarp;
...
protected:
  ...
  QDjViewShapes      *shapesWidget;
  QDockWidget        *shapesDock;
  QDjViewSamplesArea     *samplesWidget;
  QDockWidget        *samplesDock;
  QDjViewText        *textWidget;
  QDockWidget        *textDock;
  QDjViewPoliqarp    *poliqarpWidget;
  QDockWidget        *poliqarpDock;
  // document data
